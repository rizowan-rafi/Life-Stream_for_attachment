      ...
      <section className="max-w-7xl mx-auto px-6 py-10 grid lg:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex gap-4">
            ...
            <Link to="/become-a-donor" className="border border-red-600 px-8 py-4 rounded-xl font-bold hover:bg-red-50 transition">
              Become a Donor
            </Link>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto bg-red-600 text-white rounded-3xl p-16 text-center">
          ...
          <div className="flex justify-center gap-4 mt-8">
            <Link to="/become-a-donor" className="bg-white text-red-600 px-10 py-4 rounded-xl font-bold hover:bg-gray-100 transition">
              Register Now
            </Link>
